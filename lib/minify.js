...
function* minify_sync_or_async(files, options, _fs_module, scopeInfoBuilder) {
    if (
        _fs_module
...
async function minify(files, options, _fs_module, scopeInfoBuilder) {
    const gen = minify_sync_or_async(files, options, _fs_module, scopeInfoBuilder);
